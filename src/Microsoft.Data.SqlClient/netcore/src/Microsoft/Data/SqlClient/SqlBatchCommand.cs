...
#pragma warning disable CS1591 // Missing XML comment for publicly visible type or member
    ...
    public class SqlBatchCommand : DbBatchCommand
    {
        ...
        public override CommandBehavior CommandBehavior { get => _behavior; set => _behavior = value; }

        public override int RecordsAffected { get => _recordsAffected; set => _recordsAffected = value; }
